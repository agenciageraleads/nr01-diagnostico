               ...
               <motion.div key="s0" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-slate-700">Unidade ou filial avaliada</label>
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-slate-700">Número total de colaboradores</label>
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-slate-700">Trabalhadores terceirizados?</label>
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-slate-700">Home office ou híbrido?</label>
             ...
             {step === 1 && (
               <motion.div key="s1" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-8">
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-slate-700">Principais setores da empresa</label>
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-slate-700">Setores com maior pressão por prazos?</label>
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-slate-700">As metas são realistas pela gestão?</label>
             ...
             {step === 2 && (
               <motion.div key="s2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-8">
                  ...
                  <div className="space-y-6">
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-slate-700">Existe canal formal para denúncias/sugestões?</label>
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-slate-700">A empresa acompanha absenteísmo?</label>
                      <div className="flex gap-4">
                        {['Sim', 'Não'].map(opt => (
                           <button 
                            key={opt}
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-slate-700">Principais fatores de estresse identificados pela gestão</label>
